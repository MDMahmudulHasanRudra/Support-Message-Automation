      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="space-y-4">
          <Card>
            ...
            <div className="mt-4">
              <p className="mb-1 text-xs font-medium text-[color:var(--color-muted-foreground)]">Message Body</p>
              <p className="whitespace-pre-wrap rounded-md border border-[var(--color-border)] p-3 text-sm text-[color:var(--color-foreground)]">
                {message.body}
              </p>
            </div>
          </Card>
                ...
                <ul className="space-y-1.5 text-sm">
                  {trace.map((t, i) => (
                    <li
                      ...
                      className={
                        t.applied
                          ? "rounded-md border border-[var(--color-success-border)] bg-[var(--color-success-bg)] p-2 font-medium text-[color:var(--color-success-fg)]"
                          : "p-2 text-[color:var(--color-muted-foreground)]"
                      }
                    >
            ...
            {message.outboundReplies.length === 0 ? (
              ...
              <ul className="space-y-2 text-sm">
                {message.outboundReplies.map((r) => (
                  <li key={r.id} className="rounded-md border border-[var(--color-border)] p-3">
